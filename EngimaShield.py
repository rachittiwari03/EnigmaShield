...
import base64         # Vigenère cipher for encryption and decryption


#Creating the Main Window:
root = Tk()
root.geometry("1200x6000") # defining size of window
root.title("EnigmaShield: Encryption and Decryption") # setting up the title of window


#Creating Frames (Tops and f1 are created and packed within main window)
...
# Initializing variables('StringVar' variables are initialized to store message, key, mode, and result.)
Msg = StringVar()
key = StringVar()
mode = StringVar()
Result = StringVar()
